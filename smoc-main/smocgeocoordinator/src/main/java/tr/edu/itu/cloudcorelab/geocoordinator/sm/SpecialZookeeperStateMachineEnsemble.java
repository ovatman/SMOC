 ...
 */
public class SpecialZookeeperStateMachineEnsemble<S, E> extends StateMachineEnsembleObjectSupport<S, E> {

	private final static Log log = LogFactory.getLog(SpecialZookeeperStateMachineEnsemble.class);
	 ...
	 */
	public SpecialZookeeperStateMachineEnsemble(CuratorFramework curatorClient, String basePath) {
	 ...
	 */
	public SpecialZookeeperStateMachineEnsemble(CuratorFramework curatorClient, String basePath, boolean cleanState, int logSize) {
