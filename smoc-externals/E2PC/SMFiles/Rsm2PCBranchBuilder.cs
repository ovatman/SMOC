...
{
    public class Rsm2PCBranchBuilder: IRSMBuilder
    {
        private string _name;
        private bool _logging;
        public Rsm2PCBranchBuilder(string name, bool logging)
        {
            _name = name;
            _logging = logging;
        }
        public StateMachine<State, Event> BuildStateMachine(string smName)
        {
            ...
            // WRITE PATH
            sm.Configure(State.STATE4).Permit(Event.TRIVIAL_W, State.STATE5);
